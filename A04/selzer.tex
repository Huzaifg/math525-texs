...
Now, we have $\bar{c}_2=-3$, so we let $x_2$ enter the basis. The pivot column is $u=\begin{pmatrix}-1 & 2\end{pmatrix}$, and we select $i=4,l=2$ since it is the only nonzero element. $x_4$ exits the basis, and the new basis will be $\bar{B}(1)=1, \bar{B}(2)=2$.
